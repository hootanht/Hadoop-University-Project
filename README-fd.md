...
توکن را در `%USERPROFILE%\.kaggle\kaggle.json` بگذارید یا `KAGGLE_USERNAME`/`KAGGLE_KEY` را تنظیم کنید، سپس `03-fetch-data.ps1` را اجرا کنید و در گام‌های بعد `-File 2019-Oct.csv` را به‌جای `big.csv` بدهید.
